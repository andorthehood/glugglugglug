...
/** GPU geometry owned by the post-process plugin. */
...
/**
 * Creates reusable fullscreen geometry for the post-process plugin.
 *
...
/**
 * Deletes the post-process plugin's reusable fullscreen geometry.
 *
 * @param gl - WebGL2 context that owns the geometry.
...
/**
 * Establishes the default-framebuffer state required by the post-process pass.
 *
